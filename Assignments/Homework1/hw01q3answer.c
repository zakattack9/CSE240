...
int main()
{
	...
	printf("This error is contextual, because although syntactically correct and uncaught by the compiler, y's type is inconsistent with the assignment in the printf statement. \n\n");
	// Problem 4: (2 points)
